...
public class RunnerBase {
    ...
    public void setUpClass(@Optional("Android") String platformName, @Optional("Android") String udid, @Optional("Android") String deviceName, @Optional("Android") String systemPort) throws Exception {
